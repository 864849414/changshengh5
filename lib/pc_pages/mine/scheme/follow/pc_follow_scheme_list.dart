...
class PCFollowSchemeList extends StatefulWidget {
  String spProIsOver;
  PCFollowSchemeList(this.spProIsOver);

  @override
  _PCFollowSchemeListState createState() => _PCFollowSchemeListState();
}

class _PCFollowSchemeListState extends State<PCFollowSchemeList> {
